...
bool AboutScene::init() {
	...
	set->addClickEventListener(CC_CALLBACK_1(AboutScene::menuCloseCallback, this));
	auto help = static_cast<ui::Button*>(rootNode->getChildByName("Button_help"));
	help->addClickEventListener(CC_CALLBACK_1(AboutScene::menuCloseCallback, this));
	auto back = static_cast<ui::Button*>(rootNode->getChildByName("Button_back"));
	back->addClickEventListener(CC_CALLBACK_1(AboutScene::menuCloseCallback, this));
...
void AboutScene::menuCloseCallback(Ref *ptr) {
